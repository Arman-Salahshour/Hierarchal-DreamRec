...
In this project, we extend DreamRec by introducing a decoder, which can be found in the `DreamRec_Movies.py` file. By encoding genre spaces, we created a latent space that enhances the main recommender's ability to predict users' next preferred movie. We refer to our model as *Hierarchical-DreamRec*.
